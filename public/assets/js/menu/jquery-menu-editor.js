function MenuEditor(l,t) {
    var i=$("#"+l),r= {
        labelEdit:'<i class="fas fa-edit clickable"></i>',labelRemove:'<i class="fas fa-trash-alt clickable"></i>',textConfirmDelete:"This item will be deleted. Are you sure?",iconPicker: {
            cols:4,rows:4,footer:!1,iconset:"fontawesome5"
        },
        listOptions: {
            hintCss: {
            ...
            opener: {
                as:"html",close:'<i class="fas fa-minus"></i>',open:'<i class="fas fa-plus"></i>',openerCss: {
            ...
            ignoreClass:"clickable",listsClass:"pl-0",listsCss: {
                "padding-top":"10px"
            },
            complete:function(e) {
    ...
    $.extend(!0,r,t);
    var s=null,n=!0,a=null,o=null,e=r.iconPicker,c=(t=r.listOptions,$("#"+l+"_icon").iconpicker(e));
    function d() {
    ...
    function f() {
        var e=$("<div>").addClass("btn-group float-right"),s=p( {
            classCss:"btn btn-primary btn-sm btnEdit",text:r.labelEdit
        }),
        t=p( {
            classCss:"btn btn-danger btn-sm btnRemove",text:r.labelRemove
        }),
        l=p( {
            classCss:"btn  btn-sm btnUp btnMove",text:'<i class="fas fa-angle-up clickable"></i>'
        }),
        n=p( {
            classCss:"btn  btn-sm btnDown btnMove",text:'<i class="fas fa-angle-down clickable"></i>'
        }),
        o=p( {
            classCss:"btn  btn-sm btnOut btnMove",text:'<i class="fas fa-level-down-alt clickable"></i>'
        }),
        i=p( {
            classCss:"btn  btn-sm btnIn btnMove",text:'<i class="fas fa-level-up-alt clickable"></i>'
        });
    ...
    this.add=function() {
        ...
        var s=f(),t=$("<span>").addClass("txt").text(e.text),l=$("<i>").addClass(e.icon),n=$("<div>").css( {
            overflow:"auto"
        })
        .append(l).append("&nbsp;").append(t).append(s),o=$("<li>").data(e);
        ...
        if(null!==s) {
            ...
            var t=function d(e,s) {
                ...
                return $.each(e,function(e,s) {
                    var t=void 0!==s.children&&$.isArray(s.children),l= {
                        text:"",href:"",icon:"empty",target:"_self",title:""
                    },
                    n=$.extend( {
                    },
                    s);
                    ...
                    o.data(l);
                    var i=$("<div>").css("overflow","auto"),r=$("<i>").addClass(s.icon),a=$("<span>").addClass("txt").append(s.text).css("margin-right","5px"),c=f();
...
!function(L) {
    L.fn.sortableLists=function(e) {
        var s=L("body").css("position","relative"),t= {
            ...
            baseClass:"",baseCss: {
                position:"absolute",top:0-parseInt(s.css("margin-top")),left:0-parseInt(s.css("margin-left")),margin:0,padding:0,"z-index":2500
            },
            opener: {
            ...
            insertZone:50,insertZonePlus:!1,scroll:20,ignoreClass:"",isAllowed:function(e,s,t) {
                return!0
            },
        ...
        var h= {
            isDragged:!1,isRelEFP:null,oEl:null,rootEl:null,cEl:null,upScroll:!1,downScroll:!1,pX:0,pY:0,cX:0,cY:0,isAllowed:!0,e: {
                pageX:0,pageY:0,clientX:0,clientY:0
            },
            doc:L(document),win:L(window)
        };
        if(d.opener.active) {
        ...
        return this.on("mousedown touchstart",function(e) {
            ...
            if(!(!1!==h.isDragged||d.ignoreClass&&s.hasClass(d.ignoreClass))) {
                ...
                t[0]&&(d.onDragStart(e,t),function(e,s,t) {
                    h.isDragged=!0;
                    var l=parseInt(s.css("margin-top")),n=parseInt(s.css("margin-bottom")),o=parseInt(s.css("margin-left")),i=parseInt(s.css("margin-right")),r=s.offset(),a=s.innerHeight();
                    h.rootEl= {
                        el:t,offset:t.offset(),rootElClass:t.attr("class")
                    },
                    h.cEl= {
                        el:s,mT:l,mL:o,mB:n,mR:i,offset:r
                    },
                    h.cEl.xyOffsetDiff= {
                        X:e.pageX-h.cEl.offset.left,Y:e.pageY-h.cEl.offset.top
                    },
                    h.cEl.el.addClass("sortableListsCurrent "+d.currElClass),s.before(u);
                    var c=h.placeholderNode=L("#sortableListsPlaceholder");
                    s.css( {
                        width:s.width(),position:"absolute",top:r.top-l,left:r.left-o
                    })
                    .prependTo(p),c.css( {
                        display:"block",height:a
                    }),
        ...
        function v(e) {
            if(h.isDragged) {
                ...
                (e,h),n=e,(o=h.cEl).el.css( {
                    top:n.pageY-o.xyOffsetDiff.Y-o.mT,left:n.pageX-o.xyOffsetDiff.X-o.mL
                })
            }
            var n,o,i
        }
        function b(e) {
            var t=h.cEl,l=L("#sortableListsHint",h.rootEl.el),n=f[0].style,o=null,i=!1,r=L("#sortableListsHintWrapper");
    ...
    L.fn.hideButtons=function(e) {
        for(var s=0;
        s<e.length;
        s++)L(this).find(".btn-group:first").children(".btn"+e[s]).hide()
    }
}
