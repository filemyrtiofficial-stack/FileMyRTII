(function ($) {
    "use strict";
        ...
        // if ($('.rti_tab_slider').length) {
        //     if ($(window).width() < 992 && !$('.rti_tab_slider').hasClass('slick-initialized')) {
        //         $('.rti_tab_slider').slick({
        //           dots: false,
        //           arrows: true,
        //           infinite: false,
        //           speed: 1000,
        ...
        //           ]
        //     });
        //   } else if ($(window).width() >= 992 && $('.rti_tab_slider').hasClass('slick-initialized')) {
        //     $('.rti_tab_slider').slick('unslick');
        //   }
        // }
        // function handleTabSlider() {
        //     console.log("function run");
        //     if ($(window).width() < 992) {
        //         $('.rti_tab_slider li').wrap('<div class="rti_tab_item_wrap"></div>');
        //         $('.rti_tab_slider li').css('width', '100%');
        //       }
        //       else {
        //         $('.rti_tab_slider li').unwrap('.rti_tab_item_wrap');
        //       }
        //       if ($('.rti_tab_slider').length) {
        //         if ($(window).width() < 992 && !$('.rti_tab_slider').hasClass('slick-initialized')) {
        //             $('.rti_tab_slider').slick({
        ...
        function mediaForMobile() {
            console.log("ok")
              let width = $(window).width();
            if (width <= 768) {
                      $('.bg_img').each(function(){
                            const el = $(this),
                            src = el.attr('data-mobile'),
                            parent = el.parent();
                            parent.css({
        ...
        $(document).on('click', '.tabings', function(e){
            ...
            $(id).addClass('active').siblings().removeClass('active');
              ...
              $('html, body').animate({
                    scrollTop: $($('.contact_faq')).offset().top - 200
                  }, 0);
        ...
        $('html').click(function(event) {
            if ($(event.target).closest('col_dropdown').length === 0) {
                $('col_dropdown').hide();
            }
        });

        $('#attachment-popup').on('click', function(){
            $('body').css('overflow', 'hidden');
        });
        $('#attachment-popup .close-rti-popup').on('click', function(){
