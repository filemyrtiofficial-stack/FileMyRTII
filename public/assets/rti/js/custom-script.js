(function ($) {
    ...
    if ($(".testimonial_slider").length) {
        $(".testimonial_slider").slick({
            ...
            pauseOnFocus: true,
            prevArrow:
                '<button type="button" class="slick-prev"><svg width="18" height="36" viewBox="0 0 18 36" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M2.76459 19.0665L11.2501 27.552L13.3711 25.431L5.94609 18.006L13.3711 10.581L11.2501 8.45996L2.76459 16.9455C2.48339 17.2268 2.32541 17.6082 2.32541 18.006C2.32541 18.4037 2.48339 18.7852 2.76459 19.0665Z" fill="black"/></svg></button>',
            nextArrow:
                '<button type="button" class="slick-next"><svg width="18" height="36" viewBox="0 0 18 36" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M15.2354 19.0665L6.74991 27.552L4.62891 25.431L12.0539 18.006L4.62891 10.581L6.74991 8.45996L15.2354 16.9455C15.5166 17.2268 15.6746 17.6082 15.6746 18.006C15.6746 18.4037 15.5166 18.7852 15.2354 19.0665Z" fill="black"/></svg></button>',
            responsive: [
                {
                    breakpoint: 1024,
                    settings: {
    ...
    $(".menu .has-dropdown > a").after(
        '<span class="arrow-btn"><svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7 10L12 15L17 10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>'
    );
    ...
    if ($(".rti_tab_item").length) {
        $(".rti_tab_item").on("click", function () {
            ...
            $(".rti_tab[data-id='" + $(this).attr("data-id") + "']").addClass(
                "tab-active"
            );
    ...
    if ($(".form_tab_item").length) {
        $(".form_tab_item").on("click", function () {
            ...
            $(".form_tab[data-id='" + $(this).attr("data-id") + "']").addClass(
                "tab-active"
            );
