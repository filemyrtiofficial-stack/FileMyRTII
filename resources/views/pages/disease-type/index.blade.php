...
@section('content')
@include('layouts.navbars.auth.topnav', ['title' => 'Disease Type Management'])
    ...
    <div class="col-12">
        ...
        <div class="card mb-4">
            <div class="card-header pb-0 list-header">
                <h6>Disease Type</h6>
                <a href="{{route('disease-types.create')}}" class="btn bg-gradient-dark btn-sm float-end mb-0">Add
                Disease Type</a>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-end">
                                    ...
                                    href="{{route('disease.index')}}?disease_type_id={{$item->id}}">View</a>
                                        <a class="text-sm font-weight-bold mb-0 ps-2"
                                            href="{{route('disease-types.edit', $item->id)}}">Edit</a>
                                        <a href="{{route('disease-types.destroy', $item->id)}}"
