...
<li class="breadcrumb-item" aria-current="page">Blog Comments</li>

@endsection
@section('content')
@include('layouts.navbars.auth.topnav', ['title' => 'Blog Comment'])
        ...
        <div class="card mb-3">
                <div class="card-body">
                      <form action="" id="search-form">
                                <div class="row">
                                        <div class="col-md-3">
                                                <input type="text" name="search" class="form-control" placeholder="Search By Email/Name" value="{{$_GET['search'] ?? ''}}">
                                        </div>
                                        <div class="col-md-3">
                                                <input type="text" name="blog" class="form-control" placeholder="Search By Blog Name " value="{{$_GET['blog'] ?? ''}}">
                                        </div>
                                        {{--     <div class="col-md-3">
