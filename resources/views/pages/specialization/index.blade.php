    ...
    <div class="col-12">
        ...
        <div class="card mb-4">
            <div class="card-header pb-0 list-header">
                <h6>Speciality</h6>
                <a href="{{route('specialities.create')}}" class="btn bg-gradient-dark btn-sm float-end mb-0">Add
                    Speciality</a>
            </div>
                                ...
                                <td class="align-middle text-end">
                                    <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                        <a class="text-sm font-weight-bold mb-0"
                                            href="{{route('specialities.edit', $item->id)}}">Edit</a>
                                        <a href="{{route('specialities.destroy', $item->id)}}"
