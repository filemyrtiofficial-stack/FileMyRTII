...
@section('content')
@include('layouts.navbars.auth.topnav', ['title' => 'Lab Management'])
<div class="d-flex justify-content-center mb-5">
    <div class="col-lg-11 mt-lg-0 mt-4">
        <form method="POST"
            action="{{isset($data['id']) ? route('labs.update', $data['id']) : route('labs.store')}}"
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                <input id="name" name="name" class="form-control" type="text"
                                    placeholder="Lab Name" value="{{$data['name'] ?? ''}}">
                            </div>
                        </div>
                        ...
                        <div class="col-6 mt-3">
                            ...
                            <div class="input-group">
                                <input id="contact_person" name="contact_person" class="form-control" type="text"
                                    placeholder="Emails" value="{{$data['contact_person'] ?? ''}}">
                            </div>
                        </div>
                        <div class="col-6 mt-3">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body table-reponsive">
                    <div class="col-12 mt-3">
                        <div class="input-group">
                            <select id="lab_tests" name="lab_tests[]" multiple class="form-control select-2">
