...
<li class="breadcrumb-item" aria-current="page"><a href="{{route('categories.index')}}">Blog Category</a></li>
@if(isset($data['id']) )
...
@endsection
@section('content')
@include('layouts.navbars.auth.topnav', ['title' => 'Blog Category Management'])
<div class="d-flex justify-content-center mb-5">
    <div class="col-lg-9 mt-lg-0 mt-4">
        <div class="card mt-4">
            <div class="card-header">
                <h5>{{isset($data['id']) ? 'Edit' : 'New'}} Blog Category</h5>
            </div>
