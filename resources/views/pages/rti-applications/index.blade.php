...
<li class="breadcrumb-item" aria-current="page">RTI Applications</li>
@endsection
@section('content')
        ...
        <div class="card mb-3">
                <div class="card-body">
                      <form action="">
                                <div class="row">
                                        <div class="col-md-3">
                                                <input type="text" name="search" class="form-control" placeholder="Search By Application No./Email/Name/contact no." value="{{$_GET['search'] ?? ''}}">
                                        </div>
                                        <div class="col-md-3">
