...
@section('content')
@include('layouts.navbars.auth.topnav', ['title' => 'Lab Profile'])
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card card-profile">
                <img src="{{asset(($data->labPrimaryImage->image ?? ''))}}" alt=" Image
        ...
        <div class="col-md-8">
                        ...
                        <div class="col-12 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                            <div class="nav-wrapper position-relative end-0">
                                <ul class="nav nav-pills nav-fill p-1" role="tablist">
                                    <li class="nav-item">
                                        <a href="{{route('labs.show', $data->id)}}?tab=info"
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('labs.show', $data->id)}}?tab=times"
                                            class="nav-link mb-0 px-0 py-1 active d-flex align-items-center justify-content-center">
                                            <i class="ni ni-app"></i>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('labs.show', $data->id)}}?tab=gallery"
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('labs.show', $data->id)}}?tab=lab-test"
                                            class="nav-link mb-0 px-0 py-1 d-flex align-items-center justify-content-center "
                                            data-bs-toggle="tab">
                                            <i class="ni ni-settings-gear-65"></i>
                                            <span class="ms-2">Lab Tests</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('labs.show', $data->id)}}?tab=ambulance"
                                            class="nav-link mb-0 px-0 py-1 d-flex align-items-center justify-content-center "
                                            data-bs-toggle="tab">
                                            <i class="ni ni-settings-gear-65"></i>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Cpntact Person</label>
                                <input class="form-control" value="{{$data->contact_person}}" disabled>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="table-reponsive">
                        <table class="table">
                            ...
                            <tbody id="time-list">
                                @if(isset($data) && count($data->labTimes) > 0)
                                @foreach($data->labTimes as $item)
                                <tr>
                                    <td>
            ...
            <div class=" mt-3">
                <div class="row">
                    @foreach($data->labGalleryImage as $img)
            ...
            @elseif(isset($request['tab']) && $request['tab'] == 'lab-test')
            <div class="card mt-3">
            <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
