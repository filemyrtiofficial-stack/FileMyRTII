    ...
    <div class="col-12">
        ...
        <div class="card mb-4">
            <div class="card-header pb-0 list-header">
                <h6>Doctors</h6>
                <a href="{{route('doctors.create')}}" class="btn bg-gradient-dark btn-sm float-end mb-0">Add Doctor</a>
            </div>
                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="text-sm font-weight-bold mb-0">{{$item->fee}}</p>
                                </td>
                                <td>
