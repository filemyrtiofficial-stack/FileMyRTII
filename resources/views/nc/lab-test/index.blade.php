...
@section('content')
@include('layouts.navbars.auth.topnav', ['title' => 'Lab Test Management'])
    ...
    <div class="col-12">
        ...
        <div class="card mb-4">
            <div class="card-header pb-0 list-header">
                <h6>Lab Test Type</h6>
                <a href="{{route('lab-tests.create')}}" class="btn bg-gradient-dark btn-sm float-end mb-0">Add
                Lab Test Type</a>
            </div>
                                ...
                                <td class="align-middle text-end">
                                    <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                        ...
                                        <a class="text-sm font-weight-bold mb-0 ps-2"
                                            href="{{route('lab-tests.edit', $item->id)}}">Edit</a>
                                        <a href="{{route('lab-tests.destroy', $item->id)}}"
