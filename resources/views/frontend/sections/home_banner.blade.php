            ...
            <div class="row banner_row">
                <div class="col-12 col-sm-6">
                    <div class="header_text">
                        <h1 class="title">{!! $data['home_banner_title'] ?? '' !!}</h1>
                ...
                <div class="col-12 col-sm-6">
                    <div class="mobile_img">
                        <img class="img-fluid" src="{{asset($data['home_banner_banner_desktop_image'] ?? '')}}" alt="{{$data['home_banner_banner_desktop_image_alt'] ?? ''}}">
                    </div>
                </div>
            </div>
