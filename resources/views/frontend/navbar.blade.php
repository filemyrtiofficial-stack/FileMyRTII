            ...
            <div class="col-9">
                <div class="nav_wrapper">
                    <ul class="menu">
                        ...
                        <li class="fs-24 has-dropdown"><a href="javascript:void(0);">Services</a>
                                ...
                                <div class="container">
                                    <ul class="mega_menu">
                                        ...
                                        <li class="has-dropdown"><a class="fs-28" href="javascript:void(0);">Property
                                                Related RTI</a>
                                            <ul>
                                                <li class="fs-20"><a href="javascript:void(0);">Encumbrance
                                                        Certificate</a></li>
                                                <li class="fs-20"><a href="javascript:void(0);">Khasra / Pahani
                                                        Records</a></li>
                                        ...
                                        <li class="has-dropdown"><a class="fs-28" href="javascript:void(0);">Social
                                                RTI</a>
                                            <ul>
                                                <li class="fs-20"><a href="javascript:void(0);">MP/MLA Fund
                                                        Utilization</a></li>
                                                <li class="fs-20"><a href="javascript:void(0);">Gram Panchayat
                                                        Inquiry</a></li>
                                                <li class="fs-20"><a href="javascript:void(0);">Fund Utilization</a>
                                                </li>
                        ...
                        <li class="fs-24"><a href="javascript:void(0);">My RTI</a></li>
                        <li class="fs-24"><a href="javascript:void(0);">Pricing</a></li>
                        <li class="fs-24"><a href="javascript:void(0);">Blogs</a></li>
                        <li class="fs-24"><a href="javascript:void(0);">Team</a></li>
                        <li class="fs-24"><a href="javascript:void(0);">Contact Us</a></li>
                        <li class="mobile_menu">
                            <ul class="nav_menu">
                                <li class="fs-28"><a href="javascript:void(0);">Log in / Sign Up</a></li>
                                <li class="fs-28"><a href="javascript:void(0);">File My RTI Now</a></li>
                                <li class="fs-28"><a href="javascript:void(0);">My RTI</a></li>
                                <li class="fs-28"><a href="javascript:void(0);">FAQs</a></li>
                                <li class="fs-28"><a href="javascript:void(0);">Contact Us</a></li>
                            ...
                            <ul class="nav_details">
                                <li class="fs-18">Email: <a
                                        href="mailto:support@FileMyRTI.com">support@FileMyRTI.com</a></li>
                                <li class="fs-18">Phone: <a href="tel:+91 1234567890">+91 1234567890</a></li>
                                <li class="fs-18">Mon - Sun : 9:00 AM to 7:00 PM</li>
                            </ul>
                        </li>
                    </ul>
