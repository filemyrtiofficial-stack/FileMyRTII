...
<div id="pricing-matrix" class="pricing-matrix"
  ...
  @foreach($payment['amount_type'] as $key => $value)
    ...
    <div class="pm-row feature-row"
      ...
      <div class="col-feature" style="padding:6px 10px;">{{ $label }}</div>
  ...
  <div class="pm-row choose-row"
    ...
    <div class="col-title"
      style="grid-column:1 / span 2;padding:10px 12px;font-weight:700;">Select</div>
    ...
    <div class="col-basic opt-cell"
      ...
      <label for="price-basic"
        ...
        <span style="font-weight:800;font-size:18px;color:#0f172a;">₹ {{ $basicBase }}</span>
      </label>
    </div>
    ...
    <div class="col-adv opt-cell"
      ...
      <label for="price-adv"
        style="display:inline-flex;gap:8px;align-items:center;cursor:pointer;
               padding:8px 12px;border:px solid #dbe6f2;border-radius:10px;
               transition:0.2s ease;flex-wrap:wrap;">
        <input type="radio" id="price-adv" name="charges"
               value="{{ $advanceBase }}"
               style="width:20px;height:20px;cursor:pointer;">
        <span style="font-weight:800;font-size:18px;color:#0f172a;">₹ {{ $advanceBase }}</span>
      </label>
    </div>
  </div>
...
<div style="
  ...
  ">
    ...
    <div class="razorpay-logo" style="flex:1 1 120px;display:flex;justify-content:flex-start;">
      <img src='{{ asset("assets/rti/images/service-detail/razorpay.webp") }}'
           alt="Razorpay"
           style="height:42px;width:auto;max-width:100%; margin-left:-27px;">
    </div>

    <!-- Pay Now Button -->
    <div class="paynow-container" style="position:relative;flex:0 0 auto;display:flex;flex-direction:column;align-items:center;">
  ...
  <span class="secure-text" style="position:absolute;left:36px;font-size:12px;color:#999; display:flex; align-items:center;">
    <!-- Green tick slightly bigger -->
    <span style="color:#28a745; font-size:20px; font-weight:bold; margin-right:4px;">✔</span>
    Secure & Refundable
  </span>
