<div class="lawyer_req_info_modal modal" id="lawyer-request">
    <div class="lawyer_req_info_modal_wrap">
        <form action="{{route('lawyer.send-query', $data->id)}}" class="authentication" method="post">
            @csrf
            ...
            <div class="modal_action">
                <button class="theme-btn"><span>Send to Customer</span></button>
            </div>
        </form>
    </div>
